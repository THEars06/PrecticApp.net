...
const blocks: Array<{ type: BlockType; label: string; description: string }> = [
  ...
  { type: 'image', label: 'Görsel', description: 'Upload + link' },
  { type: 'gallery', label: 'Yan Yana Görsel', description: '2-5 fotoğraf + alt yazı' },
  { type: 'hero', label: 'Hero Banner', description: 'Görsel, yazı, buton' },
  { type: 'button', label: 'Buton', description: 'CTA linki' },
